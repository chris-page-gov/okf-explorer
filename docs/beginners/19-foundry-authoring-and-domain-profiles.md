...
The current Explorer does not yet claim to implement this banner contract.
The proposal becomes current behaviour only after the actual consumer and its
cross-view tests pass. See the

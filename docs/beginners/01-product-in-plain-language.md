...
| Pack author | Selecting, normalizing and documenting source material |
...
4. It normalizes useful fields: title, description, publisher, dates, formats,
...
9. A reader searches for “house prices,” filters by publisher and opens the
   record.
10. The right-hand evidence card shows the normalized value, its source and any
    qualifications.
...
artifacts. It is used for collections such as national data catalogues and the
...
The two paths are normalized into related concepts in the interface: records,
...
| Normalization or inference | The builder maps that label to a stable publisher ID |

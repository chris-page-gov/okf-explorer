# Technical guides and historical reference

Start with the [task documentation](../index.md). This index retains specialist
guides, contracts and dated research. A historical report is not current user
instructions or proof of a present deployment.
...
- [OKF Explorer from the beginning](../beginners/index.md) is the contextual
  beginner reference. It introduces the web application, Markdown
...
- [Project studio](../project-studio/index.md) is an optional eight-stage course.
  A sourced answer or a reusable bundle is a useful outcome; the learning app
  stage is optional.
...
- [OKF standards crosswalk](../okf-standards-crosswalk.md) describes alignment for API and data-catalogue fields; it does not claim
  universal OKF fields or DCAT-AP conformance.
...
- [Geospatial Map exploration](../geospatial-map-exploration.md) specifies the
  ...
  progressive external-preview design; use the current Map manual for
...
Use the [maintained example catalogue](../onboarding/examples.md).

...
self-contained HTML viewer for the AI infrastructure research material.
...
- GitHub Releases: frozen snapshots of the OKF corpus and viewer.

The public interactive view is `viewer.html`; `view.html` is a compatibility
alias for people who expect that filename.

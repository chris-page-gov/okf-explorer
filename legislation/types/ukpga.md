...
|---|---|
| URI code | `ukpga` |
| Document main type | `UnitedKingdomPublicGeneralAct` |
| Normalized category | `primary` |
| Indexed works | 17,557 |
| Jurisdiction heuristic | United Kingdom |

# Access

* [Browse](https://www.legislation.gov.uk/ukpga)
* [Atom feed](https://www.legislation.gov.uk/ukpga/data.feed)

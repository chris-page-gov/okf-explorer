...
if (previousRelease.publication_status !== 'pinned' || !/^[a-f0-9]{40}$/.test(previousRelease.version || '')
  || previousRelease.version === corpusRelease.version) throw new Error('Distinct immutable corpus versions are required.');
const approved = [
...
const receipt = { schema: 'okf-remote-mcp-build.v1', service_version: '0.4.0', inputs,
  ...
  historical_bundle_versions: [previousRelease.version, 'efb05c66616a9cd4328a86cf412780fe7bc7cf0b'] };

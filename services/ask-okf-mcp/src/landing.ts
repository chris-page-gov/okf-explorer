...
<main><h1>Ask OKF</h1><p>Explore public guidance and inspect the evidence selected for a question.</p>
...
<p>Select and copy this full address: <code>https://ask-okf.crpage.chatgpt.site/okf/mcp</code>. Use No Auth. The single read-only tool is <code>ask_okf</code>.</p>

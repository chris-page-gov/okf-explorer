...
<p>Choose <strong>Ask OKF</strong> to retrieve source pages across both collections. Reader, Search, Graph and Timeline now cover both manuals. Use the Source family facet to distinguish DMG and ADM, then inspect conceptual relationships and the official PDF pages.</p>
<p>The semantic layer also includes 20 selected statutory units with source and version provenance. These are machine extractions, not specialist-approved interpretations or a complete legal dependency set.</p>

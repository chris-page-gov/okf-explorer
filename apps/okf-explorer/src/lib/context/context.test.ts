...
import { assembleContext, canonicalJson, contextSha256, explainContext, normaliseContextBudget, validateContextIndex } from './index';
...
describe('governed context assembly, independent of any domain', () => {
  ...
  it('exposes ambiguous aliases and unresolved concepts without silently choosing', async () => {
    ...
    expect(ambiguous.selected).toHaveLength(0);
